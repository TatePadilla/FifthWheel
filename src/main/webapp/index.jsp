...
<p>Welcome to the Fifth Wheel Fanatics web page, where you can learn anything you need to know about fifth wheel brands!
	<form action="showFifthWheels" method="get">
		<input type="submit" value="Show Fifth Wheels" />
	</form>
	<p> <a href="update.jsp"> <button>Update Fifth Wheels</button></a></p>
	<p><a href="delete.jsp"><button>Delete Fifth Wheels</button></a></p>
	<p><a href="add.jsp"><button>Add Fifth Wheels</button></a></p>
</body>
</html>